...
import com.github.boybeak.timepaper.utils.Cookies;
...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public void onHeaderClick(Header header, int position) {
        ...
        if (header.id == R.id.setting_logout) {
            new AlertDialog.Builder(this)
                    .setMessage(R.string.text_dialog_logout)
                    .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            Cookies.clearCookies(SettingsActivity.this);
                            Auth.logout(SettingsActivity.this);
                            finish();
                        }
                    })
    ...
    public static class OpenSourceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
//            findPreference(getString(R.string.key_open_source_delegate_adapter))
