...
public class PopularFragment extends PaperFragment {

    private int mPage = 1;

    @Override
    public CharSequence getTitle(Context context) {
        return context.getString(R.string.title_pager_popular);
    }
    ...
    public void onLoadData() {
        super.onLoadData();
        Api.photos(getContext(), mPage, 10, Api.POPULAR).enqueue(this);
    }
